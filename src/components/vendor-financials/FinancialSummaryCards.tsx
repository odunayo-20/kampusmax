...
import type { FinancialSummaryCard, FinancialSummaryTone } from "@/types/vendor-financials";

const TONE_CLASSES: Record<FinancialSummaryTone, string> = {
...
const TONE_ACCENTS: Record<FinancialSummaryTone, string> = {
...
const TONE_TEXT: Record<FinancialSummaryTone, string> = {
