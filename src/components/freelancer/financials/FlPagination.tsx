...
export function FlPagination({ page, totalPages, total, pageSize, itemLabel, onPageChange }: FlPaginationProps) {
  ...
  return (
    <div className="mt-4 flex flex-col gap-3 border-t border-kampmax-border pt-4 sm:flex-row sm:items-center sm:justify-between">
      <p className="text-sm text-kampmax-text-secondary">
        Showing {start.toLocaleString("en-NG")}&ndash;{end.toLocaleString("en-NG")} of {total.toLocaleString("en-NG")} {itemLabel}
      </p>
