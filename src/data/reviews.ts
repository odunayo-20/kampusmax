...
// ── v8 (Adebayo's Gadgets) reviews ──────────────────────
  // Store-level and product-level reviews received by v8. The vendor reviews
  // module (Module 13) manages these from the same single source of truth the
  // public storefront reads, so the two surfaces can never diverge.
  {
    id: "r31",
    targetId: "v8",
    target: "vendor",
    userId: "u2",
    rating: 5,
    title: "Reliable gadget store",
    comment:
      "Bought my MacBook from Adebayo's Gadgets and the whole process was smooth. Honest about condition, fast delivery to my hostel, and the price beat the market. Highly recommended!",
    verifiedPurchase: true,
    helpfulCount: 4,
    helpfulBy: ["u1", "u4", "u5"],
  ...
  },
  {
    ...
    userId: "u4",
    rating: 5,
    title: "Genuine products, great service",
    comment:
      "The Apple Watch I got was brand new and sealed as described. Seller responds quickly on chat and even set up the watch for me. 10/10 experience.",
    verifiedPurchase: true,
    helpfulCount: 2,
    helpfulBy: ["u2"],
  ...
  },
  {
    ...
    userId: "u5",
    rating: 4,
    title: "Good store, delivery took a day",
    comment:
      "Products are authentic and well-priced. Delivery promised same-day but arrived next morning - not a big deal for me but worth noting. Would buy again.",
    verifiedPurchase: true,
    helpfulCount: 1,
    helpfulBy: ["u1"],
  ...
  },
  {
    ...
    userId: "u3",
    rating: 5,
    title: "Best prices on campus for gear",
    comment:
      "Third time buying from this store - always authentic, always fairly priced. The MX Master mouse was exactly as described and works perfectly. This is my plug for tech on campus.",
    verifiedPurchase: true,
    helpfulCount: 3,
    helpfulBy: ["u2", "u4"],
    vendorResponse: {
      text: "Thank you Ibrahim! Great to have you back as a repeat customer. We always keep fresh stock coming in.",
  ...
  },
  {
    ...
    userId: "u2",
    rating: 5,
    title: "iPhone exactly as described",
    comment:
      "95% battery health as promised, zero scratches. Came with original box, charger and a case. Everything verified before I paid via escrow. Excellent!",
    verifiedPurchase: true,
    helpfulCount: 3,
    helpfulBy: ["u4", "u5"],
  ...
  },
  {
    ...
    userId: "u2",
    rating: 5,
    title: "MacBook Air M2 for studies",
    comment:
      "Perfect condition, battery lasts all day for lectures. Seller let me test it fully before buying. Best campus tech purchase I've made.",
    verifiedPurchase: true,
    helpfulCount: 2,
    helpfulBy: ["u1", "u5"],
  ...
  },
  {
    ...
    userId: "u4",
    rating: 5,
    title: "Apple Watch Series 9 — sealed",
    comment:
      "Brand new and factory sealed exactly as the listing said. Warranty checked and valid. Seller even shared the activation guide. Very satisfied.",
    verifiedPurchase: true,
    helpfulCount: 1,
    helpfulBy: ["u1"],
  ...
  },
  {
    ...
    comment:
      "Sony XM5 sounds amazing and ANC is top tier for studying in the library. Barely used as described, box and case included. Delivery was a bit late.",
    verifiedPurchase: true,
    helpfulCount: 1,
    helpfulBy: ["u3"],
  ...
  },
  {
    ...
    userId: "u4",
    rating: 4,
    title: "Pixel 8 Pro in great shape",
    comment:
      "Screen is perfect, only minor corner wear as stated. Camera is incredible for content creation. Seller was transparent about condition. 4 stars because charging brick not included.",
    images: [
      {
        id: "ri16",
        url: "https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=400",
        alt: "Pixel 8 Pro phone",
      },
    ],
    verifiedPurchase: true,
    helpfulCount: 2,
  ...
  },
  {
    ...
    userId: "u3",
    rating: 5,
    title: "MX Master 3S — daily driver",
    comment:
      "Smooth, quiet and the battery is a beast. Same-day pickup at the shop was quick. Great value for a student setup.",
    verifiedPurchase: true,
    helpfulCount: 3,
    helpfulBy: ["u1", "u2", "u4"],
